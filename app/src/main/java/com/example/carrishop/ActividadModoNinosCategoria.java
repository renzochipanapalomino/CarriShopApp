    ...
    private List<KidsCategoryItem> buildItemsFor(KidsCategory category) {
        ...
        switch (category) {
            case COLORS:
                ...
                items.add(new KidsCategoryItem("color_amarillo", getString(R.string.kids_color_yellow), "", yellow, "color_amarillo"));
                ...
                items.add(new KidsCategoryItem("color_morado", getString(R.string.kids_color_purple), "", purple, "color_morado"));
                items.add(new KidsCategoryItem("color_rosa", getString(R.string.kids_color_pink), "", pink, "color_rosa"));
                items.add(new KidsCategoryItem("color_blanco", getString(R.string.kids_color_white), "", ContextCompat.getColor(this, R.color.white), "color_blanco"));
            ...
            case NUMBERS:
                ...
                break;
            case FRUITS:
                items.add(new KidsCategoryItem("fruta_manzana", getString(R.string.kids_fruit_apple), "🍎", red, "frutas_manzana"));
                items.add(new KidsCategoryItem("fruta_platano", getString(R.string.kids_fruit_banana), "🍌", yellow, "frutas_platano"));
                items.add(new KidsCategoryItem("fruta_naranja", getString(R.string.kids_fruit_orange), "🍊", orange, "frutas_naranja"));
                items.add(new KidsCategoryItem("fruta_uvas", getString(R.string.kids_fruit_grape), "🍇", purple, "frutas_uvas"));
                items.add(new KidsCategoryItem("fruta_sandia", getString(R.string.kids_fruit_watermelon), "🍉", green, "frutas_sandia"));
                break;
            case VOWELS:
            ...
            case ANIMALS:
            default:
                items.add(new KidsCategoryItem("animal_leon", getString(R.string.kids_animal_lion), "🦁", orange, "animal_leon"));
                items.add(new KidsCategoryItem("animal_elefante", getString(R.string.kids_animal_elephant), "🐘", teal, "animal_elefante"));
                items.add(new KidsCategoryItem("animal_mono", getString(R.string.kids_animal_monkey), "🐵", brown, "animal_mono"));
                items.add(new KidsCategoryItem("animal_rana", getString(R.string.kids_animal_frog), "🐸", green, "animal_rana"));
