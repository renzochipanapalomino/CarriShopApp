    ...
    private List<KidsCategoryItem> buildItemsFor(KidsCategory category) {
        ...
        switch (category) {
            case COLORS:
                ...
                items.add(new KidsCategoryItem("color_marron", getString(R.string.kids_color_purple), "", purple, "color_marron"));
                items.add(new KidsCategoryItem("color_purpura", getString(R.string.kids_color_pink), "", pink, "color_purpura"));
                items.add(new KidsCategoryItem("color_rosado", getString(R.string.kids_color_white), "", ContextCompat.getColor(this, R.color.white), "color_rosado"));
                items.add(new KidsCategoryItem("color_negro", getString(R.string.kids_color_black), "", ContextCompat.getColor(this, R.color.black), "color_negro"));
                break;
            case NUMBERS:
                ...
                break;
            case FRUITS:
                items.add(new KidsCategoryItem("frutas", getString(R.string.kids_fruit_apple), "🍎", red, "frutas"));
                items.add(new KidsCategoryItem("frutas", getString(R.string.kids_fruit_banana), "🍌", yellow, "frutas"));
                items.add(new KidsCategoryItem("frutas", getString(R.string.kids_fruit_orange), "🍊", orange, "frutas"));
                items.add(new KidsCategoryItem("frutas", getString(R.string.kids_fruit_grape), "🍇", purple, "frutas"));
                items.add(new KidsCategoryItem("frutas", getString(R.string.kids_fruit_watermelon), "🍉", green, "frutas"));
                break;
            case VOWELS:
                items.add(new KidsCategoryItem("vocales", getString(R.string.kids_vowel_a), "A", pink, "vocales"));
                items.add(new KidsCategoryItem("vocales", getString(R.string.kids_vowel_e), "E", orange, "vocales"));
                items.add(new KidsCategoryItem("vocales", getString(R.string.kids_vowel_i), "I", blue, "vocales"));
                items.add(new KidsCategoryItem("vocales", getString(R.string.kids_vowel_o), "O", green, "vocales"));
                items.add(new KidsCategoryItem("vocales", getString(R.string.kids_vowel_u), "U", purple, "vocales"));
                break;
            case ANIMALS:
            default:
                items.add(new KidsCategoryItem("animal_perro", getString(R.string.kids_animal_lion), "🦁", orange, "animal_perro"));
                items.add(new KidsCategoryItem("animal_gallo", getString(R.string.kids_animal_elephant), "🐘", teal, "animal_gallo"));
                items.add(new KidsCategoryItem("animal_gato", getString(R.string.kids_animal_monkey), "🐵", brown, "animal_gato"));
                items.add(new KidsCategoryItem("animal_chivo", getString(R.string.kids_animal_frog), "🐸", green, "animal_chivo"));
